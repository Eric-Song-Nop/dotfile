...
nnoremap <silent> <leader>zp     :<C-u>CocCommand fzf-preview.FromResources project_mru git<CR>
nnoremap <silent> <leader>zgs    :<C-u>CocCommand fzf-preview.GitStatus<CR>
nnoremap <silent> <leader>zga    :<C-u>CocCommand fzf-preview.GitActions<CR>
nnoremap <silent> <leader>zb     :<C-u>CocCommand fzf-preview.Buffers<CR>
nnoremap <silent> <leader>zB     :<C-u>CocCommand fzf-preview.AllBuffers<CR>
nnoremap <silent> <leader>zo     :<C-u>CocCommand fzf-preview.FromResources buffer project_mru<CR>
nnoremap <silent> <leader>z<C-o> :<C-u>CocCommand fzf-preview.Jumps<CR>
nnoremap <silent> <leader>zg;    :<C-u>CocCommand fzf-preview.Changes<CR>
nnoremap <silent> <leader>z/     :<C-u>CocCommand fzf-preview.Lines --add-fzf-arg=--no-sort --add-fzf-arg=--query="'"<CR>
nnoremap <silent> <leader>z*     :<C-u>CocCommand fzf-preview.Lines --add-fzf-arg=--no-sort --add-fzf-arg=--query="'<C-r>=expand('<cword>')<CR>"<CR>
nnoremap          <leader>zgr    :<C-u>CocCommand fzf-preview.ProjectGrep<Space>
xnoremap          <leader>zgr    "sy:CocCommand   fzf-preview.ProjectGrep<Space>-F<Space>"<C-r>=substitute(substitute(@s, '\n', '', 'g'), '/', '\\/', 'g')<CR>"
nnoremap <silent> <leader>zt     :<C-u>CocCommand fzf-preview.BufferTags<CR>
nnoremap <silent> <leader>zq     :<C-u>CocCommand fzf-preview.QuickFix<CR>
nnoremap <silent> <leader>zl     :<C-u>CocCommand fzf-preview.LocationList<CR>
