...
beautiful.hotkeys_font = "Sans 22"
    ...
    awful.button({ }, 3, function ()
        ...
        return function ()
            if instance and instance.wibox.visible then
                ...
                instance = awful.menu.clients({theme = {width = dpi(500)}})
            end
        end
    end),
...
lain.layout.cascade.tile.offset_x      = dpi(4)
lain.layout.cascade.tile.offset_y      = dpi(64)
lain.layout.cascade.tile.extra_padding = dpi(10)
...
function _G_moveFloatWindow(c, e)
  if c.floating  then
    if e == 0 then
      c.x = c.x-25
    elseif e==1 then
...
globalkeys = my_table.join(
    ...
    -- Function keys
    awful.key({altkey }, "F12", function () awful.util.spawn( "xfce4-terminal --drop-down" ) end,
    ...
    awful.key({ modkey1, altkey   }, "i", function() awful.spawn.with_shell("nitrogen --restore") end,
 ...
 -- Show/Hide Systray
    ...
    awful.key({ altkey, modkey1 }, "j", function () lain.util.useless_gaps_resize(1) end,
              {description = "increment useless gaps", group = "tag"}),
    awful.key({ altkey, modkey1 }, "h", function () lain.util.useless_gaps_resize(-1) end,
    ...
    awful.key({ altkey, "Control"}, "Left", function () _G_moveFloatWindow(client.focus, 0) end),
    awful.key({ altkey, "Control"}, "Right", function () _G_moveFloatWindow(client.focus, 1) end),
    awful.key({ altkey, "Control"}, "Up", function () _G_moveFloatWindow(client.focus, 3) end),
    awful.key({ altkey, "Control"}, "Down", function () _G_moveFloatWindow(client.focus, 2) end),
    ...
    -- Widgets popups
    awful.key({ modkey,           }, "p", function () awful.spawn(terminal, {floating=true,  placement = awful.placement.centered,}) end,
              {description = terminal,group = "super"}),
...
-- Useless Key
    ...
    -- awful.key({ modkey1, altkey   }, "v", function() awful.util.spawn( browser3 ) end,
...
awful.spawn.with_shell("xinput disable IPTS\\ Touch")
